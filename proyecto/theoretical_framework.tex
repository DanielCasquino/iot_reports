...
The EW1-50RP's own controller displays the water temperature measured at the center of the tank. The panel includes an on/off button, temperature adjustment buttons, and a heating indicator; red denotes heating and green denotes temperature preservation~\cite{rheemmanual}. Reading this display avoids estimating the tank temperature from an external pipe, which can be misleading when there is no active water flow.
