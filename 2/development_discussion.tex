...
\begin{enumerate}
    ...
    \item \textbf{Checkpoint 2: Carry out the physical implementation and record a demonstration video.}
          ...
          \begin{itemize}
              \item The physical implementation is demonstrated in the following video, as well as in the picture below:
                    \href{https://drive.google.com/file/d/1lb-KOxjORNLkK3BwuQjImiEukMwBvksX/view?usp=drive_link}{view video demonstration}.
          \end{itemize}

          \begin{figure}[htbp]
              \centering
              \includegraphics[width=1\linewidth]{img/sistema_1.png}
              \caption{System 1 implementation. LEDs are powered on or off depending on the potentiometer resistance.}\label{fig:system_1}
          \end{figure}
    ...
    \item \textbf{Checkpoint 4: Carry out the physical implementation and record a demonstration video.}
          ...
          \begin{itemize}
              \item The physical implementation is demonstrated in the following video:
                    \href{https://drive.google.com/file/d/1jt73U9jTPeC79SI0v_eQKez06liPBJ8F/view?usp=drive_link}{view video demonstration}, and in the figure below.
          \end{itemize}

          \begin{figure}[htbp]
              \centering
              \includegraphics[width=1\linewidth]{img/sistema_2.png}
              \caption{System 2 implementation. The LEDs turn on when the photoresistors are covered.}\label{fig:system_2}
          \end{figure}
...
\begin{enumerate}
    ...
    \item \textbf{Checkpoint 6: Carry out the physical implementation and record a demonstration video.}
          ...
          \begin{itemize}
              ...
              \item The following image also shows a photo of the implemented system.
          \end{itemize}

          \begin{figure}[htbp]
              \centering
              \includegraphics[width=1\linewidth]{img/sistema_3.png}
              \caption{Evacuation message shown when the gas sensor detects gas signatures.}\label{fig:system_3}
          \end{figure}
...
\begin{enumerate}
    ...
    \item \textbf{Checkpoint 7: Carry out the physical implementation and record a demonstration video.}
          ...
          \begin{figure}[htbp]
              \centering
              \includegraphics[width=1\linewidth]{img/sistema_4.png}
              \caption{Distance and temperature monitoring with system 4.}\label{fig:system_4}
          \end{figure}
...
\begin{enumerate}
    ...
    \item \textbf{Checkpoint 9: Carry out the physical implementation and record a demonstration video.}
          ...
          \begin{figure}[htbp]
              \centering
              \includegraphics[width=1\linewidth]{img/sistema_6.png}
              \caption{Left: PWM analogWrite with the potentiometer at max value. Right: analogWrite at min value.}\label{fig:system_6}
          \end{figure}
...
\begin{enumerate}
    ...
    \item \textbf{Checkpoint 10: Carry out the physical implementation and record a demonstration video.}
          ...
          \begin{itemize}
              ...
              \item A picture of the final circuit is shown below:
          \end{itemize}

          \begin{figure}[htbp]
              \centering
              \includegraphics[width=1\linewidth]{img/sistema_7.png}
              \caption{A picture of the final circuit (the motor is actually moving, we promise).}\label{fig:system_7}
          \end{figure}
...
\begin{enumerate}
    ...
    \item \textbf{Checkpoint 11: Carry out the physical implementation and record a demonstration video.}
          ...
          \begin{figure}[htbp]
              \centering
              \includegraphics[width=1\linewidth]{img/sistema_8.png}
              \caption{Irrigation system on watering mode (LED blue on), while the humidity sensor is dry.}\label{fig:system_8}
          \end{figure}
